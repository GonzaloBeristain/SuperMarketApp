                    ...
                    <tr className="border-2 h-7 text-center">
                        ...
                        <td className="px-2">
                            <Link href={`/admin/update/${product.id}`}>
                                <button onClick={() => handleEdit(product.id)} type="button" className="border-2 text-xl p-1 bg-orange-600 text-white rounded-xl  hover:bg-orange-800 duration-300 transition-colors shadow">
